...
public class KeystoreTruststoreCreator {
    ...
    public void createKeystore(List<String> data, int passwordLength, String alias)
        throws PemToPKCS12ConverterException {
        String password = generator.generate(passwordLength);
        creator.saveKeystoreData(converter.convertKeystore(data, password, alias), password);
    }
