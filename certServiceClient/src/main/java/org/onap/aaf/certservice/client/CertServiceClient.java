...
//            filesCreator.createKeystore(certServiceData.getCertificateChain(), 24, "certificate", keyPair.getPrivate());
//            filesCreator.createTruststore(certServiceData.getTrustedCertificates(), 24, "certificate-");
