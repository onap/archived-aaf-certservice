...
public class CsrFactory {
    ...
    public String createEncodedCsr(KeyPair keyPair) {
        ...
        try {
            ...
            LOGGER.error("Generation of CSR failed, exception message: {}", e.getMessage());
    ...
    private PKCS10CertificationRequest createPKCS10Csr(X500Principal subject, KeyPair keyPair) throws OperatorCreationException {
    ...
    private String convertPKC10CsrToPem(PKCS10CertificationRequest request) {
