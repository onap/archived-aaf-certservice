...
public class PKCS12ArtifactsCreator implements ArtifactsCreator {
    ...
    public PKCS12ArtifactsCreator(CertFileWriter creator, RandomPasswordGenerator generator,
    ...
    private void createKeystore(List<String> data, PrivateKey privateKey)
        ...
        creator.saveData(converter.convertKeystore(data, password, CERTIFICATE_ALIAS, privateKey), KEYSTORE_P12);
    ...
    private void createTruststore(List<String> data)
        ...
        creator.saveData(converter.convertTruststore(data, password, TRUSTED_CERTIFICATE_ALIAS), TRUSTSTORE_P12);
