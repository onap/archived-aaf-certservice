...
class KeyPairFactoryTest {
    ...
    @Test
    public void shouldProvideKeyPairGenerator_whenCreateKeyPairGeneratorCalled() throws NoSuchAlgorithmException {
        //  given
        ...
        //  when
        keyPairGenerator = keyPairFactory.createKeyPairGenerator();
    }
}