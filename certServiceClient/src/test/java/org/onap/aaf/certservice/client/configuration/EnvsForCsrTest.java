...
class EnvsForCsrTest {
    ...
    @Test
    void shouldReturnSystemEnvOrganizationUnitVariableWhenItWasDefined() {
        // given
    ...
    @Test
    public void shouldReportThatSystemEnvOrganizationUnitVariableIsNotPresentWhenItWasNotDefined() {
        // when
        final Optional<String> testEnv = envsForCsr.getOrganizationUnit();
