...
public class CmpServersConfig {
    ...
    public LoadingStatus reloadConfiguration() {
        LOGGER.info(REFRESHING_CONFIGURATION);
        return loadConfiguration();
    }

    LoadingStatus loadConfiguration() {
        ...
        try {
            ...
            return new LoadingStatus(true);
        } catch (CmpServersConfigLoadingException e) {
            LOGGER.error(e.getMessage(), e.getCause());
            return new LoadingStatus(false, e.getMessage());
        }
    }
    ...
    public static class LoadingStatus {
        ...
        public LoadingStatus(boolean success) {
            this(success, "");
        }

        public LoadingStatus(boolean success, String message) {
