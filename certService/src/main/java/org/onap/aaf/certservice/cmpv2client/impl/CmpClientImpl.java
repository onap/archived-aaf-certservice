...
public class CmpClientImpl implements CmpClient {
  ...
  public List<List<X509Certificate>> createCertificate(
    ...
    final CreateCertRequest certRequest =
        CmpMessageBuilder.of(CreateCertRequest::new)
            .with(CreateCertRequest::setIssuerDn, csrMeta.getIssuerX500NameOrGenerateIfNull())
            .with(CreateCertRequest::setSubjectDn, csrMeta.getX500NameOrGenerateIfNull())
  ...
  private void validate(
    ...
    CmpUtil.notNull(csrMeta.getX500NameOrGenerateIfNull(), "Subject DN");
    CmpUtil.notNull(csrMeta.getIssuerX500NameOrGenerateIfNull(), "Issuer DN");
