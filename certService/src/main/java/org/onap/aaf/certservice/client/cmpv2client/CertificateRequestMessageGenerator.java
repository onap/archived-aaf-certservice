 ...
 */
package org.onap.aaf.certservice.client.cmpv2client;

import static org.onap.aaf.certservice.client.cmpv2client.CmpUtil.createRandomInt;
import static org.onap.aaf.certservice.client.cmpv2client.CmpUtil.generateOptionalValidity;
import static org.onap.aaf.certservice.client.cmpv2client.CmpUtil.createRandomBytes;
import static org.onap.aaf.certservice.client.cmpv2client.CmpUtil.generatePkiHeader;
import static org.onap.aaf.certservice.client.cmpv2client.CmpUtil.generateProofOfPossession;
import static org.onap.aaf.certservice.client.cmpv2client.CmpUtil.generateProtectedBytes;
...
import org.onap.aaf.certservice.client.cmpv2client.impl.CmpClientException;
...
public class CertificateRequestMessageGenerator {
    ...
    private final String externalCaAuthenticationPassword;
    ...
    public static class CertificateRequestMessageGeneratorBuilder {
        ...
        public CertificateRequestMessageGeneratorBuilder setNotBefore(Optional<Date> notBefore) {
            this.notBefore = notBefore;
            return this;
        }

        public CertificateRequestMessageGeneratorBuilder setNotAfter(Optional<Date> notAfter) {
     ...
     */
    public PKIMessage generateCertificateRequestMessage() throws CmpClientException {
        ...
        final CertTemplateBuilder certTemplateBuilder = new CertTemplateBuilder()
                                                                ...
                                                                .setExtensions(generatorExtension())
                                                                .setValidity(generateOptionalValidity(notBefore, notAfter))
                                                                .setPublicKey(SubjectPublicKeyInfo.getInstance(subjectKeyPair.getPublic().getEncoded()));

        CertRequest certRequest = new CertRequest(certReqId, certTemplateBuilder.build(), null);
    ...
    /**
     * Creating standard Extensions.
     *
     * @return Extensions
     */
    private Extensions generatorExtension() throws CmpClientException {
        ...
        try {
            ...
            extGenerator.addExtension(Extension.subjectAlternativeName, false, new GeneralNames(sansGeneralNames));
