...
public final class CmpResponseHelper {
     ...
     * @return model for certification containing
            ...
            throws IOException, CertificateParsingException, CmpClientException
    {
        ...
        if(extraCerts!=null){
            mapCertificates(certificates, extraCerts);
        }

        CMPCertificate[] caPubsCerts = certRepMessage.getCaPubs();
        if(caPubsCerts!=null) {
            mapCertificates(certificates, caPubsCerts);
        }
    ...
    private static void mapCertificates(
            Map<X500Name, X509Certificate> certificates, CMPCertificate[] extraCerts)
            throws CertificateParsingException, CmpClientException, IOException
    {
        for (CMPCertificate certificate : extraCerts) {
    ...
    private static Cmpv2CertificationModel extractCertificationModel
        ...
        return new Cmpv2CertificationModel(certificateChain, new ArrayList<>(certificates.values()));
    }
