...
public class CertificationExceptionController {
    ...
    public ResponseEntity<String> handle(CmpClientException exception) {
        ...
        return getErrorResponseEntity("Exception occurred during call to cmp client", HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<String> handle(Cmpv2ClientAdapterException exception) {
        ...
        return getErrorResponseEntity("Exception occurred parsing cmp client response", HttpStatus.INTERNAL_SERVER_ERROR);
    }
