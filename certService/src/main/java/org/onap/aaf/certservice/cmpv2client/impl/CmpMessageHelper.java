...
public class CmpMessageHelper {
  ...
  private static final int certReqId = createRandomInt(100000000);
  ...
  public static OptionalValidity generateOptionalValidity(
      final Optional<Date> notBefore, final Optional<Date> notAfter) {
   ...
   */
  public static Extensions generateExtension(final List<String> sansList) throws IOException {
   ...
   * @throws {@link CmpClientException}.
   */
   ...
   */
  public static AlgorithmIdentifier protectionAlgoIdentifier() {
   ...
   */
  public static PKIMessage protectPkiMessage(PKIHeader pkiHeader, PKIBody pkiBody, String password)
