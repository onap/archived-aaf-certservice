...
public class PKIErrorException extends Exception {
  ...
  public PKIErrorException(PKIStatusInfo statusInfo) {
    this(new org.onap.aaf.certservice.cmpv2client.impl.PKIStatusInfo(statusInfo));
  }

  public PKIErrorException(org.onap.aaf.certservice.cmpv2client.impl.PKIStatusInfo statusInfo) {
