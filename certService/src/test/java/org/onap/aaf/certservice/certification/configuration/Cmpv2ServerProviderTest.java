...
class Cmpv2ServerProviderTest {
    ...
    void shouldReturnOptionalWithServerWhenServerWithGivenCaNameIsPresentInConfig() {
        // given
        String testCaName = "TestCa";
        Cmpv2Server testServer = createTestServer(testCaName);
    ...
    private Cmpv2Server createTestServer(String testCaName) {
        Cmpv2Server testServer = new Cmpv2Server();
        testServer.setCaName(testCaName);
