...
class CSRModelFactoryTest {
    ...
    void certificateProviderShouldDecryptCSRAndReturnStringWithDataAboutIt() throws CSRDecryptionException {
        ...
        // when
        CSRModel decryptedCSR = csrModelFactory.createCSRModel(new StringBase64(encoderCST), new StringBase64(encoderPK));
    ...
    void certificateProviderShouldThrowCSRDecryptionExceptionIfCSRareIncorrect() {
        ...
        Exception exception = assertThrows(
                ...
                () -> csrModelFactory.createCSRModel(new StringBase64(wrongCSR), new StringBase64(encoderPK))
        );
