...
class CmpResponseHelperTest {
    ...
    private static final String TEST_3LAYER_ENTITY_CERT =  "" +
            "-----BEGIN CERTIFICATE-----\n" +
    ...
    private static final String TEST_3LAYER_INTERMEDIATE_CERT = "" +
            "-----BEGIN CERTIFICATE-----\n" +
    ...
    private static final String TEST_3LAYER_CA_CERT = "" +
            "-----BEGIN CERTIFICATE-----\n" +
    ...
    @Test
    void returnListOfCertificationWhenGivenCaCertInCmpCertificatesAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        PKIMessage respPkiMessage = mockPkiMessage(null);
        ...
        CertRepMessage certRepMessage = mockCertRepMessage(cmpCertificates);
        ...
        // then
        assertThatChainContainsEntityCertificate(certs, TEST_2LAYER_ENTITY_CERT);

        assertThatRootCaAndTrustedCaAreInSecondList(certs, caCmpCertificate);
    }

    @Test
    void returnListOfCertificationWhenGivenCaCertInExtraCmpCertificatesAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        CMPCertificate caCmpCertificate = mockCmpCertificateFromPem(TEST_2LAYER_CA_CERT);
        CMPCertificate[] extraCmpCertificates = { caCmpCertificate };
        PKIMessage respPkiMessage = mockPkiMessage(extraCmpCertificates);

        CertRepMessage certRepMessage = mockCertRepMessage(null);
    ...
    @Test
    void returnListOfCertificationWhenGivenCertInCmpCertificatesAndCaCertInExtraCmpCertificatesAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        CMPCertificate caCmpCertificate = mockCmpCertificateFromPem(TEST_2LAYER_CA_CERT);
        ...
        CMPCertificate trustedCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_CA_CERT);
    ...
    @Test
    void returnListOfCertificationWhenGivenTwoCertInCmpCertificatesAndAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        CMPCertificate trustedCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_CA_CERT);
    ...
    @Test
    void returnListOfCertificationWhenGivenCACertAndIntermediateCertInExtraCmpCertificatesAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        CMPCertificate caCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_CA_CERT);
        CMPCertificate intermediateCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_INTERMEDIATE_CERT);
        CMPCertificate[] extraCmpCertificates = { caCmpCertificate, intermediateCmpCertificate };
        PKIMessage respPkiMessage = mockPkiMessage(extraCmpCertificates);

        CertRepMessage certRepMessage = mockCertRepMessage(null);

        X509Certificate leafCertificate = getX509CertificateFromPem(TEST_3LAYER_ENTITY_CERT);
        ...
        // then
        assertThatChainContainsEntityAndIntermediateCertificate(certs, TEST_3LAYER_ENTITY_CERT, TEST_3LAYER_INTERMEDIATE_CERT);
    ...
    @Test
    void returnListOfCertificationWhenGivenCACertInCmpCertificatesAndIntermediateCertInExtraCmpCertificatesAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        CMPCertificate intermediateCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_INTERMEDIATE_CERT);
    ...
    @Test
    void returnListOfCertificationWhenGivenCACertAndTrustedCertInCmpCertificatesAndIntermediateCertInExtraCmpCertificatesAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        CMPCertificate intermediateCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_INTERMEDIATE_CERT);
        ...
        CMPCertificate[] cmpCertificates = { caCmpCertificate, trustedCmpCertificate };
        CertRepMessage certRepMessage = mockCertRepMessage(cmpCertificates);
    ...
    @Test
    void returnListOfCertificationWhenGivenCACertAndFirstTrustedCertInCmpCertificatesAndIntermediateCertAndSecondTrustedCertInExtraCmpCertificatesAndEntityCertInLeafCertificate()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        CMPCertificate intermediateCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_INTERMEDIATE_CERT);
        CMPCertificate trustedCmpCertificate01 = mockCmpCertificateFromPem(TEST_2LAYER_ENTITY_CERT);
        CMPCertificate[] extraCmpCertificates = { intermediateCmpCertificate, trustedCmpCertificate01 };
        PKIMessage respPkiMessage = mockPkiMessage(extraCmpCertificates);

        CMPCertificate caCmpCertificate = mockCmpCertificateFromPem(TEST_3LAYER_CA_CERT);
        CMPCertificate trustedCmpCertificate02 = mockCmpCertificateFromPem(TEST_2LAYER_CA_CERT);
        CMPCertificate[] cmpCertificates = { caCmpCertificate, trustedCmpCertificate02 };
        CertRepMessage certRepMessage = mockCertRepMessage(cmpCertificates);
        ...
        assertThatRootCaAndTrustedCaAreInSecondList(
                certs,
                caCmpCertificate, trustedCmpCertificate01, trustedCmpCertificate02
        );
    }

    @Test
    void throwsExceptionWhenNoCaCertForEntityCertIsGiven()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        String expectedMessage = "Something was wrong with the supplied certificate";
    ...
    @Test
    void throwsExceptionWhenBothExtraCertsAndPcbCertsAreEmpty()
            throws CertificateException, CmpClientException, IOException, NoSuchProviderException
    {
        //  given
        String expectedMessage = "Something was wrong with the supplied certificate";
    ...
    private void assertThatRootCaAndTrustedCaAreInSecondList(Cmpv2CertificationModel certs,CMPCertificate... rootAndTrustedCerts) throws CertificateEncodingException, IOException {
    ...
    private PKIMessage mockPkiMessage(CMPCertificate[] cmpCertificates) {
    ...
    private CertRepMessage mockCertRepMessage(CMPCertificate[] cmpCertificates) {
