...
public class ReloadConfigControllerTest {
    ...
    public void shouldRethrowSameErrorWhenFailedToReload() throws CmpServersConfigLoadingException {
        // Given
        final String ERROR_MESSAGE = "Exception occurred during CMP Servers configuration loading";
    ...
    void shouldReturnErrorStatusAndMessageWhenExceptionOccurred() {
        // Given
        String expectedMessage = "Exception occurred during CMP Servers configuration loading";
        CmpServersConfigLoadingException exception = new CmpServersConfigLoadingException(expectedMessage);
